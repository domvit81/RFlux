...
## PLOT
    ...
    "pww_win" = tl_pww_win -LAG.MAX-1,
    "pwt_win" = tl_pwt_win -LAG.MAX-1,
	"pwb" = peak_ref -LAG.MAX-1,
    "pwb_win" = peak_ref2 -LAG.MAX-1, 
	"pwb_adj" = peak_ref5 -LAG.MAX-1,
    "pwb_lci"= hdis[1] -LAG.MAX-1,
    "pwb_uci"= hdis[2] -LAG.MAX-1,
    "pwb_win_lci"= hdis2[1] -LAG.MAX-1,
    "pwb_win_uci"= hdis2[2] -LAG.MAX-1,
    "pwb_adj_lci" = min(CRIN) -LAG.MAX-1,
    "pwb_adj_uci" = max(CRIN) -LAG.MAX-1,
    "cor_pww" = cor_pww,
    "cor_pwt" = cor_pwt,
